    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class="table table-bordered table-smaller-font" class="table table-bordered" id="dataTable"
                    ...
                    <tbody>
                        @foreach ($apartamentos as $item)
                            <tr>
                                <td>{{ @$item->contratos->first()->inquilino->nome ?? 'Sem inquilino' }}</td>                                
                                <td>{{ @$item->contratos->first()->inquilino->telefone }}</td>
                                <td>{{ $item->imovel->edificio }}</td>
                                <td>{{ $item->numero }}</td>
                                <td>R${{ number_format($item->valor, 2, ',', '.') }}</td>
                                <td>{{ @$item->contratos->first()->vencimento }}</td>
                                <td>{{ @$item->contratos->first() ? 'Locado' : 'Disponível' }}</td>
                                <td>{{ @$item->contratos->first()->status->status ?? '' }}</td>
                                <td>
                                    <div class="btn-group">
